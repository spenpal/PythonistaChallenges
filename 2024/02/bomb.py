    ...
    round(
        (
            ...
            * (
                (s1[1] - s3[1])
                * (
                    ((s2[2] * 0.343) ** 2 - s2[0] ** 2 - s2[1] ** 2)
                    - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)
                )
                - (s1[1] - s2[1])
                * (
                    ((s3[2] * 0.343) ** 2 - s3[0] ** 2 - s3[1] ** 2)
                    - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)
                )
            )
        )
        / (4 * ((s1[0] - s2[0]) * (s1[1] - s3[1]) - (s1[0] - s3[0]) * (s1[1] - s2[1])))
    ),
    round(
        (
            2
...
# Test Cases
print(find((5, 8, 48.872), (12, 21, 35.107), (24, 20, 22.203)))
print(find((18, 42, 35.558), (39, 16, 106.004), (7, 24, 32.202)))
print(find((42, 19, 98.004), (3, 17, 122.484), (28, 29, 61.294)))
