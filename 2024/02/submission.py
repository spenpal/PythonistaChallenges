...
find = lambda s1, s2, s3: (round((2 * ((s1[1] - s3[1]) * (((s2[2] * 0.343) ** 2 - s2[0] ** 2 - s2[1] ** 2) - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)) - (s1[1] - s2[1]) * (((s3[2] * 0.343) ** 2 - s3[0] ** 2 - s3[1] ** 2) - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)))) / (4 * ((s1[0] - s2[0]) * (s1[1] - s3[1]) - (s1[0] - s3[0]) * (s1[1] - s2[1])))), round((2 * ((s1[0] - s2[0]) * (((s3[2] * 0.343) ** 2 - s3[0] ** 2 - s3[1] ** 2) - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)) - (s1[0] - s3[0]) * (((s2[2] * 0.343) ** 2 - s2[0] ** 2 - s2[1] ** 2) - ((s1[2] * 0.343) ** 2 - s1[0] ** 2 - s1[1] ** 2)))) / (4 * ((s1[0] - s2[0]) * (s1[1] - s3[1]) - (s1[0] - s3[0]) * (s1[1] - s2[1])))))
